            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  name="saveAndClose"
                  className="flex-1 bg-blue-100 text-blue-600 border border-blue-600 py-3 px-6 rounded-md font-medium text-sm hover:bg-blue-200 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
                  Add & Close
                </button>
                <button
